        ...
        <div id="calls" class="bpbm-tab">
            <?php if(bpbm_fs()->can_use_premium_code() && ! is_ssl() ){ ?>
                <div class="bp-better-messages-connection-check bpbm-error" style="margin: 20px 0;">
                    <p><strong>Website must to have SSL certificate</strong> in order to audio and video calls work.</p>
                    <p>This is security requirements by browsers. Contact your hosting company to enable SSL certificate at your website.</p>
                    <p><small>This notice will be hidden when website will work via HTTPS</small></p>
                </div>
            <?php } ?>
